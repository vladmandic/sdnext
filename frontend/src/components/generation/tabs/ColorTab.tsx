  ...
  return (
    <div className="flex flex-col gap-3 text-sm">
      ...
      <ParamSection title="Latent Corrections" defaultOpen={false}>
        ...
        <div className="flex items-center gap-2">
          <Label className="text-2xs text-muted-foreground w-16 flex-shrink-0">Clamp</Label>
        ...
        <div className="flex items-center gap-2">
          <Label className="text-2xs text-muted-foreground w-16 flex-shrink-0">Maximize</Label>
      ...
      <ParamSection title="Basic" defaultOpen={false}>
        <ParamGrid>
          <ParamSlider label="Brightness" value={state.gradingBrightness} onChange={set.gradingBrightness} min={-1} max={1} step={0.05} />
          <ParamSlider label="Contrast" value={state.gradingContrast} onChange={set.gradingContrast} min={-1} max={1} step={0.05} />
          <ParamSlider label="Saturation" value={state.gradingSaturation} onChange={set.gradingSaturation} min={-1} max={1} step={0.05} />
          <ParamSlider label="Hue" value={state.gradingHue} onChange={set.gradingHue} min={0} max={1} step={0.05} />
          <ParamSlider label="Gamma" value={state.gradingGamma} onChange={set.gradingGamma} min={0.1} max={10} step={0.1} />
          <ParamSlider label="Sharpness" value={state.gradingSharpness} onChange={set.gradingSharpness} min={0} max={2} step={0.05} />
        </ParamGrid>
      ...
      <ParamSection title="Tone" defaultOpen={false}>
        <ParamGrid>
          <ParamSlider label="Shadows" value={state.gradingShadows} onChange={set.gradingShadows} min={-1} max={1} step={0.05} />
          <ParamSlider label="Midtones" value={state.gradingMidtones} onChange={set.gradingMidtones} min={-1} max={1} step={0.05} />
        ...
        <ParamSlider label="Highlights" value={state.gradingHighlights} onChange={set.gradingHighlights} min={-1} max={1} step={0.05} />
      </ParamSection>
      ...
      <ParamSection title="Split Toning" defaultOpen={false}>
        ...
        <ParamSlider label="Balance" value={state.gradingSplitToneBalance} onChange={set.gradingSplitToneBalance} min={0} max={1} step={0.05} />
      </ParamSection>

      <ParamSection title="Effects" defaultOpen={false}>
        <ParamGrid>
          <ParamSlider label="Vignette" value={state.gradingVignette} onChange={set.gradingVignette} min={0} max={1} step={0.05} />
          <ParamSlider label="Grain" value={state.gradingGrain} onChange={set.gradingGrain} min={0} max={1} step={0.05} />
        </ParamGrid>
      </ParamSection>

      <ParamSection title="LUT" defaultOpen={false}>
        <div className="flex items-center gap-2">
          <Label className="text-2xs text-muted-foreground w-16 flex-shrink-0">File</Label>
          {hasLut ? (
        ...
        <ParamSlider label="Strength" value={state.gradingLutStrength} onChange={set.gradingLutStrength} min={0} max={2} step={0.05} disabled={!hasLut} />
      </ParamSection>
    </div>
  );
}
