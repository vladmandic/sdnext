  ...
  return (
    <ParamSection title="Output" defaultOpen={false}>
      ...
      <div className="flex items-center gap-2">
        <Label className="text-[11px] text-muted-foreground w-16 shrink-0">Codec</Label>
        <Combobox value={codec} onValueChange={(v) => setParam("codec", v)} options={["libx264", "libx265", "libvpx-vp9", "libaom-av1"]} className="h-7 text-xs flex-1" />
      </div>
      <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        <Label className="text-[11px] text-muted-foreground w-16 shrink-0">Codec opts</Label>
        <input
          type="text"
          value={codecOptions}
          onChange={(e) => setParam("codecOptions", e.target.value)}
          className="flex-1 h-7 text-xs px-2 rounded border border-input bg-background"
        />
      </div>
      <div className="flex items-center gap-2">
        <Label className="text-[11px] text-muted-foreground w-16 shrink-0">Video</Label>
      ...
      <div className="flex items-center gap-2">
        <Label className="text-[11px] text-muted-foreground w-16 shrink-0">Safetensors</Label>
