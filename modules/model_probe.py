...
FINGERPRINTS = (
    ...
    ArchFingerprint('qwen21', 'Qwen Image 2.1', (r'^transformer_blocks\.\d+\.img_mlp\.gate_layer', r'^modulation\.')),
    ArchFingerprint('qwen', 'Qwen Image', (r'^transformer_blocks\.\d+\.img_mlp', r'^time_text_embed\.'), forbidden=(r'audio_attn', r'^modulation\.')),
...
FAMILY_NAME_HINTS = (
    ...
    ('krea', 'krea2'), ('qwen-image-2.1', 'qwen21'), ('qwen', 'qwen'), ('wan', 'wanai'), ('anima', 'anima'),
