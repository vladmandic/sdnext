...
def register_api():
    ...
    # New REST API
    api.add_api_route("/sdapi/v1/civitai/search", get_search, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/model/{model_id}", get_model, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/version/{version_id}", get_version, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/version/by-hash/{hash_str}", get_version_by_hash, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/options", get_options, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/download", post_download, methods=["POST"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/download/{download_id}/cancel", post_download_cancel, methods=["POST"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/download/status", get_download_status, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/settings", get_settings, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/settings", post_settings, methods=["POST"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/resolve-path", get_resolve_path, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/metadata/scan", post_metadata_scan, methods=["POST"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/metadata/update", post_metadata_update, methods=["POST"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/favorites", get_favorites, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/favorites", post_favorite, methods=["POST"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/favorites/{name}", delete_favorite, methods=["DELETE"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/banned", get_banned, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/banned", post_banned, methods=["POST"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/banned/{name}", delete_banned, methods=["DELETE"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/history", get_history, methods=["GET"], tags=["CivitAI"])
    api.add_api_route("/sdapi/v1/civitai/history", delete_history, methods=["DELETE"], tags=["CivitAI"])
