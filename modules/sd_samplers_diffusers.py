...
config = {
    ...
    'RES-Unified 2M': { 'rk_type': 'res_2m' },
    'RES-Unified 3M': { 'rk_type': 'res_3m' },
    'RES-Unified 2S': { 'rk_type': 'res_2s' },
    'RES-Unified 3S': { 'rk_type': 'res_3s' },
    'RES-Singlestep 2S': { 'variant': 'res_2s' },
    'RES-Singlestep 3S': { 'variant': 'res_3s' },
    'RES-Multistep 2M': { 'variant': 'res_2m' },
    'RES-Multistep 3M': { 'variant': 'res_3m' },
    'RES-SDE 2S': { 'variant': 'res_2s' },
    'RES-SDE 3S': { 'variant': 'res_3s' },
    'DEIS-Multistep': { 'order': 2 },
    'DEIS-Unified 1S': { 'rk_type': 'deis_1s' },
    'DEIS-Unified 2M': { 'rk_type': 'deis_2m' },
...
samplers_data_diffusers = [
    ...
    SamplerData('DEIS-Unified 1S', lambda model: DiffusionSampler('DEIS-Unified 1S', DEISUnifiedScheduler, model), [], {}),
    SamplerData('DEIS-Unified 2M', lambda model: DiffusionSampler('DEIS-Unified 2M', DEISUnifiedScheduler, model), [], {}),
