...
prev_model = ''
lock = threading.Lock()
supported = ['sd', 'sdxl', 'sd3', 'f1', 'h1', 'z_image', 'lumina2', 'hunyuanvideo', 'wanai', 'chrono', 'cosmos', 'mochivideo', 'pixartsigma', 'pixartalpha', 'hunyuandit', 'omnigen', 'qwen', 'longcat', 'omnigen2', 'flite', 'ovis']
...
def get_model(model_type = 'decoder', variant = None):
    ...
    if model_cls is None or model_cls == 'none':
        ...
        model_cls = 'sdxl'
    elif model_cls in {'h1', 'z_image', 'lumina2', 'chroma', 'longcat', 'omnigen2', 'flite', 'ovis'}:
        model_cls = 'f1'
