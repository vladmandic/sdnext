...
class TEEDDetector:
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_or_path="fal-ai/teed", cache_dir=None, local_files_only=False):
        from installer import install
        install('controlnet-aux', quiet=True)
        from controlnet_aux import TEEDdetector as _TEEDdetector
        model = _TEEDdetector.from_pretrained(pretrained_model_or_path, cache_dir=cache_dir)
        return cls(model)
