...
config = {
    ...
    'DWPose (Legacy)': {'class': None, 'group': 'Pose', 'checkpoint': False, 'detector': 'm', 'params': {'min_confidence': 0.3, 'draw_body_pose': True, 'draw_hand_pose': True, 'draw_face_pose': True}},
...
def delay_load_config():
    ...
    config = {
        ...
        'DWPose (Legacy)': {'class': RtmlibPoseDetector, 'group': 'Pose', 'checkpoint': False, 'detector': 'm', 'params': {'min_confidence': 0.3, 'draw_body_pose': True, 'draw_hand_pose': True, 'draw_face_pose': True}},
