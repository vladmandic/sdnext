...
options_templates.update(options_section(("quantization", "Model Quantization"), {
    ...
    "sdnq_svd_rank": OptionInfo(32, "SVDQuant Rank size", gr.Slider, {"minimum": 1, "maximum": 512, "step": 1}),
    "sdnq_svd_steps": OptionInfo(8, "SVDQuant quantization steps", gr.Slider, {"minimum": 1, "maximum": 128, "step": 1}),
