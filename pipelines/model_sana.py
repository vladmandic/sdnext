...
def load_quants(kwargs, repo_id, cache_dir):
    ...
    if 'Sana_1600M_1024px' in repo_id and model_quant.check_nunchaku('Model'): # only available model
        ...
        log.debug(f'Load module: quant=Nunchaku module=transformer repo="{nunchaku_repo}" precision={nunchaku_precision} attention={shared.opts.nunchaku_attention}')
...
def load_sana(checkpoint_info, kwargs=None):
    ...
    try:
        ...
        log.error(f'Load model: type=Sana {e}')
