...
class BooguImageTurboPipeline(DiffusionPipeline):
    ...
    # Copied from diffusers.pipelines.boogu.pipeline_boogu.BooguImagePipeline.encode_prompt
    def encode_prompt(
        self,
        instruction: Union[str, List[str]],
    ...
    def __call__(
        ...
        (
            instruction_embeds,
            instruction_attention_mask,
            _negative_instruction_embeds,
            _negative_instruction_attention_mask,
            _empty_instruction_embeds,
            _empty_instruction_attention_mask,
        ) = self.encode_prompt(
            instruction,
        ...
        _input_images, width, height, _ori_width, _ori_height = self._resolve_output_and_original_size(
            input_images=None,
